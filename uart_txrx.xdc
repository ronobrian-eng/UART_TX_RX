...
## USB-UART
set_property PACKAGE_PIN A18 [get_ports {TxD}] ; set_property IOSTANDARD LVCMOS33 [get_ports {TxD}]
set_property PACKAGE_PIN B18 [get_ports {RxD}] ; set_property IOSTANDARD LVCMOS33 [get_ports {RxD}]
